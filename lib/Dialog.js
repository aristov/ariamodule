...
export class Dialog extends Window {
    ...
    create(init) {
        ...
        this.setAttr(Expanded.Transition, false)
    }
    ...
    onTransitionEnd(event) {
        if(event.target === this.node) {
            if(Expanded.Transition.getAttrOf(this).node.value === 'true-false') {
    ...
    set expanded(expanded) {
        if(expanded) {
            this.install()
            this.bindEvents()
            this.setAttr(Expanded.Transition, true)
            this.focus()
        }
        else {
            this.setAttr(Expanded.Transition, false)
     ...
     */
    get expanded() {
        return this.getAttr(Expanded.Transition)
    }
