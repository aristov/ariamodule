...
export class GridCell extends Cell {
     ...
     */
    get belowCell() {
        const sibling = this.column[this.rowIndex + (this.rowSpan || 1)]
        return sibling && !sibling.disabled? sibling.ownerCell : null
    }
     ...
     */
    get column() {
        return this.rowGroup.rows.map(row => row.cells[this.colIndex])
    }
     ...
     */
    get nextCell() {
        const sibling = this.row.cells[this.colIndex + (this.colSpan || 1)]
        return sibling && !sibling.disabled? sibling.ownerCell : null
    }
     ...
     */
    get prevCell() {
        const sibling = this.row.cells[this.colIndex - 1]
        return sibling && !sibling.disabled? sibling.ownerCell : null
    }
