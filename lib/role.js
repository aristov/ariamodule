...
/**
 * @see {@link https://www.w3.org/TR/wai-aria-1.1/#host_general_role}
 * @see {@link https://www.w3.org/TR/role-attribute}
 */
export class RoleAttrAssembler extends AttrAssembler {
    ...
    find(assembler, selectorPart) {
        ...
        if(node) {
            const element = this.getInstance(node, assembler)
     ...
     */
    static get role() {
        return this.name.replace(/^ARIA/, '').toLowerCase()
    }
