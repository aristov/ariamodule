 ...
 * @see https://www.w3.org/1999/xhtml/vocab#XHTMLRoleVocabulary
 */
export class RoleAttrAssembler extends AttrAssembler {
     ...
     * @param {Element|ElementAssembler|*} [init.ownerElement]
     */
    assign(init) {
    ...
    static create(init) {
        if(this.abstract) {
            throw Error(`Could not create an abstract ${ this.role } instance`)
        }
