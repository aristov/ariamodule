...
import { EventTargetAssembler } from 'dommodule/lib/eventtarget'
...
export class RoleAttrAssembler extends AttrAssembler {
     ...
     */
    contains(object) {
        const instance = object instanceof RoleAttrAssembler?
            object.ownerElement :
    ...
    on(type, callback, options) {
        this.ownerElement.on(type, callback, this[getOptions](options))
    }
    ...
    un(type, callback, options) {
        this.ownerElement.un(type, callback, this[getOptions](options))
    }
    ...
    static getInstanceOf(object) {
        return object?
            this.getAssemblerOf(object).getInstanceOf(object) :
            null
    }
...
Object.defineProperty(HTMLElementAssembler.prototype, 'role', {
     ...
     */
    get() {
        return RoleAttrAssembler.getAttrOf(this)
    }
})
