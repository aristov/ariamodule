...
const AriaTypeApplicable = exports.AriaTypeApplicable = require('./AriaTypeApplicable')
const AriaTypeBoolean = exports.AriaTypeBoolean = require('./AriaTypeBoolean')
const AriaTypeIdRef = exports.AriaTypeIdRef = require('./AriaTypeIdRef')
const AriaTypeIdRefList = exports.AriaTypeIdRefList = require('./AriaTypeIdRefList')
const AriaTypeInteger = exports.AriaTypeInteger = require('./AriaTypeInteger')
const AriaTypeNumber = exports.AriaTypeNumber = require('./AriaTypeNumber')
const AriaTypeString = exports.AriaTypeString = require('./AriaTypeString')
const AriaTypeToken = exports.AriaTypeToken = require('./AriaTypeToken')
const AriaTypeTokenList = exports.AriaTypeTokenList = require('./AriaTypeTokenList')
const AriaTypeTristate = exports.AriaTypeTristate = require('./AriaTypeTristate')
const RoleType = exports.RoleType = require('./RoleType')
