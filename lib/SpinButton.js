...
export class SpinButton extends Range {
    ...
    set valueNow(valueNow) {
        ...
        this._decrementButton.setAttr(Disabled, valueNow !== null && valueNow <= this.valueMin)
        this._incrementButton.setAttr(Disabled, valueNow !== null && valueNow >= this.valueMax)
    }
